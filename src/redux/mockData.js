export default [
  ...
  { id: 3, 
    user: 'user 3', 
    dateCreated: new Date(2018, 2, 18),
    comment: 'The quick brown fox jumps over the lazy dog', 
    refComment: 1 },
  { id: 2, 
    user: 'user 2', 
    dateCreated: new Date(2018, 2, 22),
    comment: 'The quick brown fox jumps over the lazy dog', 
    refComment: null },
  ...
  { id: 11, 
    user: 'user 4', 
    dateCreated: new Date(2018, 3, 1),
    comment: 'The quick brown fox jumps over the lazy dog', 
    refComment: null },
  { id: 12, 
    user: 'user 3', 
    dateCreated: new Date(2018, 3, 12),
    comment: 'The quick brown fox jumps over the lazy dog', 
    refComment: null },
  
  { id: 5, 
    user: 'user 2', 
    dateCreated: new Date(2018, 5, 8),
    comment: 'The quick brown fox jumps over the lazy dog', 
    refComment: 1 },
  { id: 6, 
    user: 'user 2', 
    dateCreated: new Date(2018, 5, 18),
    comment: 'The quick brown fox jumps over the lazy dog', 
    refComment: 2 },
  { id: 7, 
    user: 'user 4', 
  ...
  { id: 8, 
    user: 'user 1', 
    dateCreated: new Date(2018, 6, 18),
    comment: 'The quick brown fox jumps over the lazy dog', 
    refComment: 3 },
  { id: 9, 
    user: 'user 2', 
  ...
  { id: 10, 
    user: 'user 2', 
    dateCreated: new Date(2018, 12, 18),
    comment: 'The quick brown fox jumps over the lazy dog', 
    refComment: 6 },
